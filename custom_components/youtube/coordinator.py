...
class YouTubeDataUpdateCoordinator(DataUpdateCoordinator[dict[str, Any]]):
    ...
    async def _async_update_data(self) -> dict[str, Any]:
        ...
        try:
            ...
            async for superchat in youtube.get_super_chat_events():
                latest_superchat= {
                    ATTR_USER_ID: superchat.snippet.supporterDetails.channel_id,
                    ATTR_USER_NAME: superchat.snippet.supporterDetails.display_name,
                    ATTR_AMOUNT: superchat.snippet.amount_micros,
                    ATTR_CURRENCY: superchat.snippet.currency,
                    ATTR_MESSAGE: superchat.snippet.comment_text
                }
                res[superchat.superchat.id] = {
